...
running them. The risk section reports observable signals such as a dirty worktree,
symlinks, large files, and credential-shaped filenames; it does not inspect file
contents or claim to perform a security scan.
